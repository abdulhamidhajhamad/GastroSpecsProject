    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h1 className="font-serif text-5xl md:text-6xl text-black leading-tight mb-6">
      ...
      <section className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { value: 'Worldwide', label: 'Countries Served' },
              { value: '500+', label: 'Items Sourced' },
              { value: '40-60%', label: 'Average Savings vs. Local' },
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="font-serif text-3xl text-black mb-6 leading-tight">Three services. One mission.</h2>
          ...
          <div>
            ...
            <h2 className="font-serif text-3xl text-black mb-6 leading-tight">Serving clients in every region.</h2>
      ...
      <section className="bg-black">
        <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="font-serif text-3xl text-white">Work with us.</h2>
