...
export default function CategoryStatCards({
  ...
  const stats = [
    { label: 'TOTAL CATEGORIES', value: total, trend: '+1', trendUp: true },
    { label: 'SUB-CATEGORIES', value: subTotal, trend: '+4', trendUp: true },
    { label: 'MACHINES LINKED', value: machinesLinked, trend: '+12%', trendUp: true },
    { label: 'SUPPLIERS LINKED', value: suppliersLinked, trend: '+3', trendUp: true },
  ]
