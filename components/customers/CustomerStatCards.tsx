...
export default function CustomerStatCards({
  ...
  const stats = [
    { label: 'TOTAL CUSTOMERS', value: total, trend: '+5%', trendUp: true },
    { label: 'COUNTRIES', value: countries, trend: '0%', trendUp: true },
    { label: 'ACTIVE CUSTOMERS', value: withOrders, trend: '+12%', trendUp: true },
    { label: 'NEW THIS MONTH', value: newThisMonth, trend: '+1', trendUp: true },
  ]
